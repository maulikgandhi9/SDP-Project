...
//   HttpSession session = request.getSession();
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-collapse justify-content-md-center" id="navbarsExampleCenteredNav">
                    <ul class="nav nav-pills nav-jusified">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="itBooks.jsp">IT</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <%
                    for (Book b : b_list) {
                        if (!b.getD_email().equals(session.getAttribute("email")) && b.getB_dept().equalsIgnoreCase("it")) {
                %>
                <div class="col-lg-4">
                    <div class="card mt-4 mb-2 h-100">
                        ...
                        <div class="card-footer text-center">
                            <form method="post" action="smailRequest" id="<%= b.getB_id()%>">
                                ...
                                <input type="hidden" name="dept" value="<%=b.getB_dept()%>">
                                <input type="hidden" name="downvotes" value="<%= b.getDownvotes()%>">
                                <div class="card">
