            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-collapse justify-content-md-center" id="navbarsExampleCenteredNav">
                    <ul class="nav nav-pills nav-jusified">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="itSM.jsp">IT</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="row">
                ...
                <%
                    for (studyMaterial s : s_list) {
                        if (!s.getD_email().equals(session.getAttribute("email")) && s.getS_dept().equalsIgnoreCase("it")) {
                %>
                <div class="col-lg-4">
                    <div class="card mt-4 mb-2 h-80" style="background: rgba(255, 255, 255, 0.8);">
